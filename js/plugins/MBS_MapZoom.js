...
// MBS - Map Zoom (v1.3.6)
//-----------------------------------------------------------------------------
// por Masked, edited by Sir Legna (plugin enable/disable command)
//=============================================================================
//-----------------------------------------------------------------------------
 ...
 * scene.
 *
 * - Sir Legna added a plugin enable and disable command
 *
 * ===========================================================================
 * How to use
 * ===========================================================================
 ...
 * MapZoom reset 30
 * 
 * MapZoom enable [True/False]
 * 
 * This will enable and disable future plugin commands
 * Without modifying current settings
 * 
 ...
 *
 * @param Enable plugin
 * @desc If you want to disable this plugin then you mark this as false
 * @default true
 */
/*:pt
 *
 * @author Masked/Sir Legna
 ...
 * cena do mapa.
 *
 * -  [Eng] Sir Legna added a plugin enable and disable command
 *
 * ===========================================================================
 * Utilização
 * ===========================================================================
 ...
 * MapZoom enable [True/False]
 * 
 * [Eng] This will enable and disable future plugin commands
 * [Eng] Without modifying current settings
 *
 ...
 *
 * @param Enable plugin
 * @desc [Eng] If you want to disable this plugin then you mark this as false
 * @default true
 */
...
(function ($) {
  ...
  // Flag to enable/disable entire plugin
  $.Param.pluginCommandFunctionality = ($.Parameters["Enable plugin"].toLowerCase() === "true");
  ...
  Game_Interpreter.prototype.pluginCommand = function (command, args) {
	  ...
	  if (args[0] == "enable"){
		  if (args[1].toLowerCase() === "true"){
			  $.Param.pluginCommandFunctionality = (args[1].toLowerCase() === "true");
			 //Set enable flag to true
		  } else if (args[1].toLowerCase() === "false"){
			 //set enable flag to false
			 $.Param.pluginCommandFunctionality = !(args[1].toLowerCase() === "false");
		  } else {
			  console.log(`The command "MapZoom enable" must take either True or False, such as "MapZoom enable True"`)
		  }
	  }
  	 else if (args[0] == "set" && $.Param.pluginCommandFunctionality) {
  	  	if (args[1]) {
  	  	  if (args[2]) {
  	  	  	if (args[2] == "duration") {
  	  	  		if (args[3]) {
  	  ...
  	  } else if (args[0] == "reset" && $.Param.pluginCommandFunctionality) {
  	  	if (args[1]) {
  	  ...
  	  } else if (args[0] == "center" && $.Param.pluginCommandFunctionality) {
  	  	if (args[1] == "event") {
